...
import bigcode.modeling.Loader as Loader
...
def main(
    ...
    fused_ffn_glu: bool = False, # fuse feed forward gate linear unit
    ...
    if unaligned_batch:
        ...
        test_prompt = [tokenizer.encode(t, bos=False, eos=False) for t in test_prompt]
        ...
        test_prompt = tokenizer.encode(test_prompt, bos=False, eos=False)
