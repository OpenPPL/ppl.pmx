...
def load(
    ...
    if dynamic_batching:
        from bigcode.modeling.dynamic_batching.Model import TensorDumper, Transformer
        from bigcode.modeling.dynamic_batching.Pipeline import BigCode
        if cache_layout != 3:
