...
def write_pmx_model(model_path, input_base_path):
    ...
    if "intermediate_size" in params['vision_config'].keys():
    ...
    write_json(pmx_params_dict, os.path.join(model_path, "pmx_vision_params.json"))
    ...
    state_dict.update({
        ...
        "vision_projection.weight": hf_model_state_dict["visual_projection.weight"]
    })
